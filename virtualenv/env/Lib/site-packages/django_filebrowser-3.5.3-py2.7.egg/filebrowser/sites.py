...
class FileBrowserSite(object):
    ...
    def get_urls(self):
        ...
        urlpatterns = patterns(
            ...
            url(r'^editor/$', path_exists(self, filebrowser_view(self.model_editor)), name="model_editor"),            
    ...
    def model_editor(self, request):
        ...
        return render_to_response('filebrowser/editor.html', {            
